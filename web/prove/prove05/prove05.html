...
<head>
   <title>Prove05</title>
   <meta charset="utf-8">
   <meta name="application-name" content="Prove05">
   <meta name="description" content="Create a PHP application to read and display data from a database.">
   ...
   <!-- Custom Stylesheet -->
   <link rel="stylesheet" type="text/css" href="prove05.css">
